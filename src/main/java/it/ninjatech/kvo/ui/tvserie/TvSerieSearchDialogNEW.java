...
public class TvSerieSearchDialogNEW extends WebDialog implements ActionListener, ListSelectionListener {

    private static final long serialVersionUID = 5589915260921364947L;
    private static TvSerieSearchDialogNEW self;

    public static TvSerieSearchDialogNEW getInstance(TvSerieSearchControllerNEW controller) {
        if (self == null) {
            boolean decorateFrames = WebLookAndFeel.isDecorateDialogs();
            WebLookAndFeel.setDecorateDialogs(true);
            self = new TvSerieSearchDialogNEW(controller);
    ...
    private final TvSerieSearchControllerNEW controller;
    ...
    private TvSerieSearchDialogNEW(TvSerieSearchControllerNEW controller) {
    ...
    private void init() {
        ...
        WebLabel message = UIUtils.makeStandardLabel("The following tv series were not found...", 16, null, SwingConstants.CENTER);
    ...
    private static abstract class Search extends WebPanel implements ActionListener {
        ...
        private void init() {
            ...
            this.ignore = UIUtils.makeStandardCheckBox("Ignore this TV Serie");
    ...
    private static class ListRenderer extends WebListCellRenderer {
        ...
        private final TvSerieSearchDialogNEW dialog;
        
        private ListRenderer(TvSerieSearchDialogNEW dialog) {
            super();
