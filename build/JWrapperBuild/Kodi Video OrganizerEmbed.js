	...
	{		
		...
		appletContent += "        archive='Kodi+Video+OrganizerApplet.jar,Kodi+Video+OrganizerApplet_sz.jar' ";
		appletContent += "        height='"+height+"' width='"+width+"' >";
		
		// Add in the archive here.
		appletContent += "  			<param name='archive' value='";
		var jars = 'Kodi+Video+OrganizerApplet.jar,Kodi+Video+OrganizerApplet_sz.jar'.split(",");
